...
namespace SpaceShooter
{
    ...
    /// </summary>
    public class RaceResultController : MonoBehaviour, IDependency<RaceSequenceController>, IDependency<RaceResultTime>
    {
        ...
        /// </summary>
        private RaceSequenceController raceSequenceController;
        public void Construct(RaceSequenceController obj) => raceSequenceController = obj;
        /// <summary>
        /// Конструктор, реализующий интерфейс зависимости от RaceResultTime
        /// </summary>
        ...
        {
            raceSequenceController.AdvanceRace();
        }
        ...
        {
           //  raceSequenceController.RestartLevel();
        }
        ...
        private void UpdateCurrentLevelStats()
        {
            ...
            //TotalStats.time += RaceController.Instance.LevelTime;
            //TotalStats.score += Player.Instance.Score;

            // бонус за время прохождения.
            int timeBonus = (int) (raceResultTime.CurrentTime - raceResultTime.GoldTime);
        ...
        {
            m_LevelTime.text = System.Convert.ToInt32(raceResultTime.GoldTime).ToString();
